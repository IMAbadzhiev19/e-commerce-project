...
namespace ECommerceApp.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public ProductController()
        {
            ...
            _httpClient.DefaultRequestHeaders.Authorization = AuthenticationHeaderValue.Parse("bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..EQC3wXqUvL2vAunKwyVy4lhygZKjkRObkHWQ4tJCErE");
        }
        ...
        public async Task<IActionResult> RemoveFromWashlist(Guid productId)
        {
            WishlistEndpoints wishlistEndpoints = new(_httpClient);
        ...
        {
            CartEndpoints cartEndpoints = new(_httpClient);
            var result = await cartEndpoints.DeleteProduct(productId);
        ...
        [HttpGet("AssignToCart")]
        public async Task<IActionResult> AssignToCart(Guid productId)
        {
            CartEndpoints cartEndpoints = new(_httpClient);
            var result = await cartEndpoints.AssignProduct(productId);
